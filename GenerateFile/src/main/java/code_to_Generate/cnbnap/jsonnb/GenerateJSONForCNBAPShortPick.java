package code_to_Generate.cnbnap.jsonnb;
...
public class GenerateJSONForCNBAPShortPick {
	...
	public static void main(String[] args) {
		...
		IntStream.range(0, NUMBER_OF_FILES).parallel().forEach(iCount -> {
			String strFileName = "CNBNAPSHORTPICK" + iCount + ".txt";
